...
const AppSidebar: React.FC = () => {
          ...
          <li key={nav.name}>
            {nav.subItems ? (
              <button
                ...
                className={`menu-item group  ${hasActiveSubItem(nav)
                  ? "menu-item-active"
                  : "menu-item-inactive"
              ...
              >
                <span
                  className={` ${hasActiveSubItem(nav)
                ...
                {(isExpanded || isHovered || isMobileOpen) && (
                  <ChevronDownIcon
                    className={`ml-auto w-5 h-5 ${openSubmenu?.type === menuType &&
  ...
  function hasActiveSubItem(nav: NavItem): boolean {
  ...
  function getMatchedSubmenu(): OpenSubmenu {
    let result: OpenSubmenu = null;
  ...
  const matchedSubmenu = useMemo(() => getMatchedSubmenu(), [pathname]);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col overflow-y-auto overflow-x-hidden duration-300 ease-linear no-scrollbar flex-1 min-h-0">
        <nav className="mb-6">
        ...
        {/* Account Section */}
        <nav className="pt-6 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li>
                <button
                  ...
                  className={`menu-item mb-10 group menu-item-inactive w-full ${!isExpanded && !isHovered
                    ? "lg:justify-center"
                    : "lg:justify-start"
                    }`}
                >
