...
interface VehicleTrackingFiltersProps {
...
const VehicleTrackingFilters: React.FC<VehicleTrackingFiltersProps> = ({
  filters,
  onFilterChange,
  onClearFilters,
  isLoading = false,
  ...
  const handleTextChange = (key: keyof VehicleFilters, value: string) => {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3 p-4 md:p-6">
      <div className="mb-4">
...
export default VehicleTrackingFilters;
