...
const COLORED_SHADE_OPTIONS = ["GRAY", "BROWN", "GREEN", "BLUE", "BRONZE", "TEA", "BLACK", "REFLECTIVE BLUE", "REFLECTIVE GREEN"];
...
const recalcItem = (item: any) => {
  ...
  return {
    ...
    totalSqft,
    value,
    standardSize: stdWidth && stdHeight ? `${stdWidth}" x ${stdHeight}"` : "—",
  };
};
