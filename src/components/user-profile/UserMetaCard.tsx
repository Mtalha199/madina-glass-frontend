...
export default function UserMetaCard({ adminProfile, onUpdate }: ProfileContentProps) {
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="relative shrink-0 w-20 h-20 rounded-full overflow-hidden bg-brand-500 flex items-center justify-center border-2 border-gray-200 dark:border-gray-800">
              {adminProfile?.profilePic && !imageError && getProfilePicUrl(adminProfile.profilePic) ? (
                <Image
                  width={80}
                  height={80}
            ...
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {adminProfile?.country ? adminProfile.country : "-" }
                </p>
              </div>
            </div>
          </div>
