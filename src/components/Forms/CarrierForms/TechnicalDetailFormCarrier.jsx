...
const TechnicalDetailFormCarrier = ({ form, MODE, DATA }) => {
  ...
  useEffect(() => {
    if (DATA) {
      setValue(
        ...
        DATA?.account?.tech_contact_name || ""
      );
      setValue(
        "techinical_contact_email",
        DATA?.account?.tech_contact_email || ""
      );
      setValue(
        "techinical_contact_skype",
        DATA?.account?.tech_contact_skype || ""
      );
      setValue(
        "techinical_contact_phone",
        DATA?.account?.tech_contact_phone || ""
      );
      setValue(
        "techinical_contact_mobile",
        DATA?.account?.tech_contact_mobile || ""
      );
    }
  }, [DATA, setValue]);
...
export default TechnicalDetailFormCarrier;
