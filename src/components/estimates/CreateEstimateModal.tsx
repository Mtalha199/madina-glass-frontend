...
export default function CreateEstimateModal({ isOpen, onClose, onSuccess }: any) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-[1300px] m-4">
      <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl overflow-y-auto max-h-[95vh]">
        <h4 className="text-2xl font-semibold mb-6">New Estimate</h4>
            ...
            {formData.customerType === "CUSTOMER" && (
              <div>
                ...
                <Input
                  ...
                  list="estimate-customer-existing-options"
                />
                <datalist id="estimate-customer-existing-options">
                  {customers.map((c: any) => (
