...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        {/* Avatar */}
        <div className="relative shrink-0 w-8 h-8 rounded-full overflow-hidden bg-brand-500 flex items-center justify-center">
          {hasProfilePic ? (
            <Image
              src={profilePicUrl!}
              alt={displayName}
      ...
      >
        <div className="flex items-center gap-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <div>
            ...
            <span className="block mr-1 font-medium text-theme-sm">{displayEmail}</span>
          </div>
        </div>
